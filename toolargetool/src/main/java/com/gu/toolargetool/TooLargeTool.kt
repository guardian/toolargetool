...
object TooLargeTool {
    ...
    /**
     * Measure the totalSize of a typed [Bundle] when written to a [Parcel].
     *
     * @param bundle to measure
    ...
    /**
     * Measure the totalSize of a [Parcelable] when written to a [Parcel].
     *
 ...
 * written at [DEBUG][Log.DEBUG] priority with the default tag: "TooLargeTool".
 *
 * @param application to log
 */
